...
export default function Main() {
  ...
  return (
    <div>
      <h1 className="text-5xl text-center text-re font-bold">Counting page </h1>
      <div className="w-full h-screen flex items-center justify-center">
        <section className="">
          ...
          <div className="pb-3 py-3">
            <p className="font-medium pb-2 text-blue-600 dark:text-blue-500 hover:underline"><Link href="second">Go to second page</Link></p>
            <p className="font-medium text-blue-600 dark:text-blue-500 hover:underline"><Link href="third">Go to thrid page</Link></p>
          </div>
